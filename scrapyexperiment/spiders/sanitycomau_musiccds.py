...
class SanityMusicCDsSpider(scrapy.Spider):
    ...
    _BASE_URL = "http://www.sanity.com.au/genre/music"

    def start_requests(self):
        # Future requests get their state from the form in the response,
        # but we need that form in the first place to submit it.
    ...
    def _parse_initial(self, response):
        # TODO: Hardcoded - a change to the site could rename these, as they're
        #       autogenerated. Filter through the form elements looking for the
        #       right labels and use those instead, and maybe regex the onclick
        #       handler to get the correct __EVENT* values.
        yield scrapy.FormRequest.from_response(
            ...
            formdata={
                ...
                # XXX: Hardcoded - these below get set by JS
                # One of the checkboxes we "clicked" above
                "__EVENTTARGET": "ctl00$BodyCph$ProductFilterCtrl$FormatRpt$ctl08$ItemCb",
                "__EVENTARGUMENT": "",
                "ctl00$GlobalScriptManager": (
                    "ctl00$BodyCph$UpdatePanel1|"
                    # The __EVENTTARGET
                    "ctl00$BodyCph$ProductFilterCtrl$FormatRpt$ctl08$ItemCb"
                ),
            },
            callback=self.parse,
            dont_click=True,
